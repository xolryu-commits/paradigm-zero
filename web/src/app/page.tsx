...
const GET_INITIAL_NODES = () => [
  { id: 0, x: 50, y: 5, label: "휘도 부대 집결 장소", type: "start", desc: "신시 북쪽 방어선 최외곽." },
  { id: 1, x: 35, y: 15, label: "제1 자동 방벽 제어소", type: "normal", desc: "도시 외곽을 감싸는 북서쪽의 방벽 AI 서브 코어. 외곽 방어 포탑이 배치되어 있다. 해킹을 통한 잠입 혹은 일부 시설 파괴를 요한다." },
  { id: 2, x: 65, y: 15, label: "제2 자동 방벽 제어소", type: "normal", desc: "도시 외곽을 감싸는 북동쪽의 방벽 AI 서브 코어. 외곽 방어 포탑이 배치되어 있다. 해킹을 통한 잠입 혹은 일부 시설 파괴를 요한다" },
  { id: 17, x: 10, y: 15, label: "드론 관제실", type: "deadend", desc: "도시 외벽을 순행하는 경비 드론들을 관리한다. 비시민권자들의 신시 진입을 대비하는 역할을 한다." },
  { id: 3, x: 20, y: 25, label: "산업 지구", type: "normal", desc: "자동화된 공장들이 여럿 위치한다." },
  { id: 4, x: 50, y: 20, label: "신시 외곽 지대", type: "normal", desc: "중앙 도시에서 떨어진 시민 거주 구역. 비교적 가난한 이들이 거주하며, 치안이 좋지 않다." },
  { id: 5, x: 80, y: 25, label: "폐기물 및 안드로이드 잔해 처리장", type: "normal", desc: "고장난 안드로이드와 도시 폐기물이 처리되는 공장 시설. 자원 및 물자의 확보가 가능할 것으로 보인다." },
  { id: 6, x: 10, y: 35, label: "군수용 물류터미널", type: "deadend", desc: "군용 안드로이드 상용화 이전 물자 공급망으로 사용되던 시설. 현재는 주로 기계 부품 및 무기 보급을 처리한다. 자원 및 물자의 확보가 가능할 것으로 보인다." },
  { id: 7, x: 30, y: 35, label: "중앙 에너지 발전소", type: "normal", desc: "신시에 전력 에너지를 공급하는 코어 시설. 보안용 안드로이드가 여럿 배치되어 주의를 요한다. 신시로 향하는 전력을 단기간 셧다운 시킬 수 있다." },
  { id: 8, x: 70, y: 35, label: "데이터 센터", type: "normal", desc: "신시의 네트워크 서버와 데이터를 관리하는 시설." },
  { id: 9, x: 90, y: 30, label: "방송 송출 센터", type: "deadend", desc: "대표 방송국이 더러 위치한다. 뉴스 등의 매체를 시청자에게 내보내기 직전 최종적으로 편성, 제어, 전송하는 장소." }, 
  { id: 16, x: 15, y: 45, label: "지하 수로", type: "normal", desc: "악취가 나지만, 경비가 삼엄하지는 않다." },
  { id: 10, x: 40, y: 45, label: "신시 경찰청", type: "normal", desc: "보안 및 시민 안전을 위해 설립된 치안 시설. 현재 안드로이드 상용화의 흐름으로, 보안용 안드로이드가 다수 배치되어 운영되고 있다." },
  { id: 11, x: 60, y: 45, label: "시들종합병원", type: "normal", desc: "신시 내에서도 손꼽히는 대형 병원. 의약품을 얻을 수 있을 것으로 보인다." },
  { id: 18, x: 85, y: 40, label: "부대 ‘알파’", type: "normal", desc: "신시에서 처음으로 안드로이드로만 구성된 부대가 위치한다. 무력 충돌이 예상된다." },
  { id: 12, x: 30, y: 55, label: "연구 단지", type: "normal", desc: "기술 개발 및 상용화가 이루어지는 곳. 정부의 적극적 지원 아래 번성 중이다." },
  { id: 13, x: 70, y: 55, label: "상업 지구", type: "normal", desc: "문화 예술의 거리가 위치한다." },
  { id: 19, x: 90, y: 60, label: "경경대학교", type: "deadend", desc: "언덕 위에 지어졌다." },
  { id: 14, x: 50, y: 65, label: "광장", type: "normal", desc: "중앙 정부 앞의 거대한 광장. 유동인구가 많다." },
  { id: 15, x: 50, y: 50, label: "중앙 정부", type: "goal", desc: "작전의 최종 목표지. 신시의 통제권을 탈취하라." },
];
